...
### BEGIN INIT INFO
# Provides:          tnt4j-streams-syslogd
# Required-Start:    $local-fs $remote_fs $network
# Required-Stop:     $local-fs $remote_fs $network
# Default-Start: 2 3 4 5
# Default-Stop: 0 1 6
# Description:       TNT4J Streams Syslogd allows data streaming, parsing from syslog into TNT4J event sinks.
# Short-Description: TNT4J Streams Syslogd
### END INIT INFO

DESC="TNT4J Streams Syslogd"
NAME=tnt4j-streams-syslogd

# The path to Jsvc
EXEC="/usr/bin/jsvc"

# The path to the folder containing tnt4j-streams-syslogd-*.jar
FILE_PATH="/home/tnt4j-streams-syslogd-1.12.0-SNAPSHOT/"
